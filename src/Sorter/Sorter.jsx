...
export default function Sorter(props) {
  ...
  return (
    <Routes>
      ...
      <Route path="/unloading_external" element={<UnloadingExternal />} />
      ...
      <Route path="/find_sheets" element={<FindSheets />} />

      <Route path="/move_sheets" element={<MoveSheets />} />
      <Route path="/letter_report" element={<LetterReport />} />
      <Route path="/filter" element={<ExFilter />} />

      <Route path="/auto_unloading" element={<AutoUnloading />} />
      <Route path="/sklad_erp" element={<Sklad3037 />} />
      <Route path="/issuance_of_cards" element={<IssuanceOfCards />} />
      <Route path="/add_cards" element={<AddCards />} />
      <Route path="/order_of_sheets" element={<OrderOfSheets />} />
      <Route path="/cards_unloading" element={<UnloadingCardsFrom3044 />} />
      <Route path="/comeback_sheet" element={<ComebackSheet />} />
      <Route path="/add_sheet_in_start" element={<AddSheetInStart />} />
      <Route path="/check_cast_test" element={<CheckCastTest />} />
      <Route path="/get_statuses_cars" element={<GetStatusesCards />} />

      <Route
        path="/count_remainder_to_production"
        element={<CountRemainderToProduction />}
      />

      <Route path="/loading_external" element={<LoadingExternal />} />
      <Route path="/phone_numbers" element={<PhoneNumbers />} />
      <Route
        path="/update_classification_in_sap_ewm"
        element={<UpdateClassificationInSapEwm />}
      />
    </Routes>
  );
}
