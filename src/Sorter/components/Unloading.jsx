        ...
        <ol>
          <li className="article__subtitle">
            ...
            <ol className="article__list sublist">
              ...
              <li>
                <p>
                  Если вагоны не найдены
                </p>
                <ol className="sublist">
                  <li>
                    Проставить дату создания поставки на месяц назад
                  </li>
                  <li>
                    <p>Если после изменения даты вагоны не найдены</p>
                    <ol>
                      <li>
                        Спросить у оператора SAP проведён ли 107 вид движения на данные вагоны
                      </li>
                      <li>
                        Если да → звонить Алёшину (1906), чтобы распределил вагоны
                      </li>
                      <li>
                        Если нет → нужно провести 107, потом звоним Алёшину (1906), чтобы распределил вагоны
                      </li>
                    </ol>
                  </li>
                </ol>
