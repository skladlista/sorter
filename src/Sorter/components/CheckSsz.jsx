      ...
      <div id="ssz-check" className="article ssz-check">
        ...
        <div className="article__div">
          <ol>
            ...
            <li className="article__subtitle">
              <p>
                После нахождения листов по SAP EWM, надо:
                <br/>- Проверить их статус (нажать ФИЗИЧЕСКИЙ ЗАПАС и снизу посмотреть колонку НАЗВАНИЕ ВИДА ЗАПАСА)
                <br/>- Найти их в Складе Листа и проверить соответствие ПЗ
                <br/>- Найти их в 1С сверить, соответствуют ли листы требованиям производственного задания
                (ДИАМЕТР, ТОЛЩИНА, МАРКА СТАЛИ, КЛАСС ПРОЧНОСТИ, НД)
              </p>
              <ol className="article__list sublist">
                <li>
